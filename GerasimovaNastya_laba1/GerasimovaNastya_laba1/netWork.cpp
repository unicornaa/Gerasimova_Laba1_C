...
//void paddCS(unordered_map<int, CompressorStation>& station, CompressorStation newCS) {
//    station.insert(pair<int, CompressorStation>(CompressorStation::ID, newCS));
...
//}
//
//void netWork::DeleteStation(int index)
//{
